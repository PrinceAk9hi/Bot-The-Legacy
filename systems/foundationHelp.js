...
module.exports=async function(client){
 ...
 {name:'👥 =mrankup grade membre1 … [note]',value:'Attribue le grade choisi à plusieurs membres en une seule commande. Indique les mentions ou IDs des membres ; la note est facultative.'},
